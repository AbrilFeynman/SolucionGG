...
{
    public class EditCatalogViewModel : ViewModelBase
    {
        public EditCatalogViewModel(IServiceFactory serviceFactory, Article obj)
        {
        ...
        public event EventHandler<ArticleEventArgs> ObjUpdated;
        ...
        void OnSaveCommandExecute(object arg)
        {
            ...
            if (IsValid)
            {
                WithClient<ICatalogService>(_ServiceFactory.CreateClient<ICatalogService>(), objClient =>
                {
                    ...
                    try
                    {
                        var savedCar = objClient.UpdateArticle(_Obj);
                        if (savedCar != null)
                        {
                            if (ObjUpdated != null)
                                ObjUpdated(this, new ArticleEventArgs(savedCar, isNew));
                        }
                    }
