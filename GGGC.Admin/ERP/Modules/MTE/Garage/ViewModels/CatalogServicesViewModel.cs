...
namespace GGGC.Admin.ERP.Modules.MTE.Garage.ViewModels
{
    ...
    public class CatalogServicesViewModel : ViewModelBase
    {
        [ImportingConstructor]
        public CatalogServicesViewModel(IServiceFactory serviceFactory)
        {
            _ServiceFactory = serviceFactory;
            EditObjectCommand = new DelegateCommand<Service>(OnEditObjectCommand);
        ...
        {
            get { return "Catalogo de Servicios"; }
        }
        ...
        ObservableCollection<Service> _OC;
        EditCatalogServicesViewModel _CurrentObjectViewModel;
        private bool entitySetIsLoading = true;
        private bool buttonNewIsEnabled = false;
        //private bool blnFirstLoading = true;


        public DelegateCommand<Service> EditObjectCommand { get; private set; }

        public DelegateCommand<Service> DetailObjectCommand { get; private set; }
        public DelegateCommand<object> NewObjectCommand { get; private set; }
        public DelegateCommand<Service> DeleteCarCommand { get; private set; }
        ...
        public ObservableCollection<Service> Servicios
        {
            get { return _OC; }
            set
            {
                ...
                {
                    _OC = value;
                    OnPropertyChanged(() => Servicios, false);
                }
            }
        }

        public EditCatalogServicesViewModel CurrentObjectViewModel
        {
                ...
                Task<string> taskResult = Task.Factory.StartNew<string>(() =>
                {
                    ...
                    WithClient<ICatalogService>(_ServiceFactory.CreateClient<ICatalogService>(), inventoryClient =>
                    {
                        ...
                        if (collection != null)
                        {
                            ...
                            {
                                foreach (Service obj in collection)
                                    _OC.Add(obj);
        ...
        void OnEditObjectCommand(Service obj)
        {
            if (obj != null)
            {
                CurrentObjectViewModel = new EditCatalogServicesViewModel(_ServiceFactory, obj);
