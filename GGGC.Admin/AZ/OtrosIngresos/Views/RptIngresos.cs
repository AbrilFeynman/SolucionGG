namespace GGGC.Admin.AZ.OtrosIngresos.Views
{
    ...
    /// <summary>
    /// Summary description for RptIngresos.
    /// </summary>
    public partial class RptIngresos : Telerik.Reporting.Report
    {
        ...
        public RptIngresos(System.Data.DataTable tbl, System.Data.DataTable tblDetalle)
        {
        ...
        private void generarHeader(System.Data.DataTable tblHeader)
        {
            try
            {
                ...
                txtNota.Value = tblHeader.Rows[0][15].ToString();
                txtNumeroDeFolio.Value = tblHeader.Rows[0][14].ToString();
                m_nombre = tblHeader.Rows[0][14].ToString();
                //Subtotal
                double cant = Convert.ToDouble(tblHeader.Rows[0][11]);
                decimal canti = Convert.ToDecimal(cant);
                textBox1.Value = "$" + cant.ToString("#,###.00", CultureInfo.InvariantCulture);
        ...
        private void generardetalle(System.Data.DataTable tblDetalle)
        {
            ...
            try
            {
                ...
                //fecha
                DateTime deit = Convert.ToDateTime(tblDetalle.Rows[0][12]);
