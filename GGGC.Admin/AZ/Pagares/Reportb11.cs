namespace GGGC.Admin.AZ.Pagares
{
    ...
    /// <summary>
    /// Summary description for Reportb11.
    /// </summary>
    public partial class Reportb11 : Telerik.Reporting.Report
    {
        public Reportb11(string folio, string cantidad, string fecha, string cantLetra, string numpagare, string numerospagares, string nombre, string direccion, string colonia, string ciudad, string estado)
        {
            //
