namespace GGGC.Admin.AZ.Pagares
{
    ...
    /// <summary>
    /// Summary description for Reportb18.
    /// </summary>
    public partial class Reportb18 : Telerik.Reporting.Report
    {
        public Reportb18(string folio, string cantidad, string fecha, string cantLetra, string numpagare, string numerospagares, string nombre, string direccion, string colonia, string ciudad, string estado)
        {
            //
