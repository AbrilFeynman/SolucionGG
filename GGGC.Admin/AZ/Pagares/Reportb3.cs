namespace GGGC.Admin.AZ.Pagares
{
    ...
    /// <summary>
    /// Summary description for Reportb3.
    /// </summary>
    public partial class Reportb3 : Telerik.Reporting.Report
    {
        public Reportb3(string folio, string cantidad, string fecha, string cantLetra, string numpagare, string numerospagares, string nombre, string direccion, string colonia, string ciudad, string estado)
        {
            //
