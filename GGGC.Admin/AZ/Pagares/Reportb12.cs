namespace GGGC.Admin.AZ.Pagares
{
    ...
    /// <summary>
    /// Summary description for Reportb12.
    /// </summary>
    public partial class Reportb12 : Telerik.Reporting.Report
    {
        public Reportb12(string folio, string cantidad, string fecha, string cantLetra, string numpagare, string numerospagares, string nombre, string direccion, string colonia, string ciudad, string estado)
        {
            //
