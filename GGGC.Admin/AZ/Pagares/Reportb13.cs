namespace GGGC.Admin.AZ.Pagares
{
    ...
    /// <summary>
    /// Summary description for Reportb13.
    /// </summary>
    public partial class Reportb13 : Telerik.Reporting.Report
    {
        public Reportb13(string folio, string cantidad, string fecha, string cantLetra, string numpagare, string numerospagares, string nombre, string direccion, string colonia, string ciudad, string estado)
        {
