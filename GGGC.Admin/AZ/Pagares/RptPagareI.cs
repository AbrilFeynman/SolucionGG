namespace GGGC.Admin.AZ.Pagares
{
	...
	/// <summary>
	/// Summary description for RptPagareI.
	/// </summary>
    public partial class RptPagareI : Telerik.Reporting.Report
	{
		public RptPagareI(string folio, string cantidad, string fecha, string cantLetra, string numpagare, string numerospagares, string nombre, string direccion, string colonia, string ciudad, string estado)
