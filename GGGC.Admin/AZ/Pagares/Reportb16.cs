namespace GGGC.Admin.AZ.Pagares
{
    ...
    /// <summary>
    /// Summary description for Reportb16.
    /// </summary>
    public partial class Reportb16 : Telerik.Reporting.Report
    {
        public Reportb16(string folio, string cantidad, string fecha, string cantLetra, string numpagare, string numerospagares, string nombre, string direccion, string colonia, string ciudad, string estado)
        {
