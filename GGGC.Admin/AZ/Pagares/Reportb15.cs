namespace GGGC.Admin.AZ.Pagares
{
    ...
    /// <summary>
    /// Summary description for Reportb15.
    /// </summary>
    public partial class Reportb15 : Telerik.Reporting.Report
    {
        public Reportb15(string folio, string cantidad, string fecha, string cantLetra, string numpagare, string numerospagares, string nombre, string direccion, string colonia, string ciudad, string estado)
        {
